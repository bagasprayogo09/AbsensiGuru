                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.jadwal.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="jam_mulai" id="jam_mulai" class="form-input mt-1 block w-full" required>
                        </div>

                        <div class="mb-4">
                            <label for="jam_selesai" class="block text-gray-700">Jam Selesai</label>
                            <input type="time" name="jam_selesai" id="jam_selesai" class="form-input mt-1 block w-full" required>
                        </div>
