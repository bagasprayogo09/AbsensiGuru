<div class="sidebar w-64 bg-gradient-to-b from-[rgb(99,99,255)] to-[rgb(244,244,244)] p-4 shadow-lg rounded-lg lg:block hidden">
    <div class="flex items-center mb-6">
        ...
        <span class="text-lg font-semibold text-black">SMA Gita Kirti 2</span>
    </div>
    <ul class="menu text-black">
        ...
        <li class="mb-4 dropdown dropdown-hover">
            ...
            <ul tabindex="0" class="dropdown-content menu bg-white rounded-box z-[1] w-48 p-2 shadow-lg">
                <li><a href="{{ route('admin.absensi.index') }}" class="p-2 hover:bg-blue-100 transition duration-200">Absensi Guru</a></li>
                <li><a href="{{ route('admin.absensi.report') }}" class="p-2 hover:bg-blue-100 transition duration-200">Laporan Absensi Guru</a></li>
            </ul>
        </li>
        <li class="mb-4">
            <a href="{{ route('admin.index') }}" class="flex items-center p-3 rounded-lg hover:bg-blue-600 hover:text-white transition duration-200">
...
<div class="lg:hidden">
    ...
    <div id="mobile-sidebar" class="sidebar w-64 bg-gradient-to-b from-[rgb(99,99,255)] to-[rgb(244,244,244)] p-4 shadow-lg rounded-lg hidden">
        <div class="flex items-center mb-6">
            <img src="https://www.smagiki2jakarta.sch.id/upload/imagecache/22577728LogoGiki-600x536.png" alt="Logo" class="h-12 w-12 mr-3 rounded-full shadow-md">
            <span class="text-lg font-semibold text-black">SMA Gita Kirti 2</span>
        </div>
        <ul class="menu text-black">
            <li class="mb-4">
                <a href="{{ route('dashboard') }}" class="flex items-center p-3 rounded-lg hover:bg-blue-600 hover:text-white transition duration-200 text-black">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-house mr-2">
                        <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/>
                    </svg>
                    Dashboard
            ...
            <li class="mb-4 dropdown dropdown-hover">
                <div tabindex="0" role="button" class="flex items-center p-2 rounded-lg hover:bg-blue-600 hover:text-white transition duration-200 text-black">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-rolodex mr-2">
                        <path d="M8 9.05a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
                        <path d="M1 1a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h.5a.5.5 0 0 0 .5-.5.5.5 0 0 1 1 0 .5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5.5.5 0 0 1 1 0 .5.5 0 0 0 .5.5h.5a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H6.707L6 1.293A1 1 0 0 0 5.293 1zm0 1h4.293L6 2.707A1 1 0 0 0 6.707 3H15v10h-.085a1.5 1.5 0 0 0-2.4-.63C11.885 11.223 10.554 10 8 10c-2.555 0-3.886 1.224-4.514 2.37a1.5 1.5 0 0 0-2.4.63H1z"/>
                    </svg>
                ...
                <ul tabindex="0" class="dropdown-content menu bg-white rounded-box z-[1] w-48 p-2 shadow-lg">
                    <li><a href="{{ route('admin.guru.create') }}" class="p-2 hover:bg-blue-100 transition duration-200 text-black">Tambah Guru</a></li>
                    <li><a href="{{ route('admin.guru.index') }}" class="p-2 hover:bg-blue-100 transition duration-200 text-black">Daftar Semua Guru</a></li>
                    <li><a href="{{ route('admin.mata_pelajaran.index') }}" class="p-2 hover:bg-blue-100 transition duration-200 text-black">Mata Pelajaran Guru</a></li>
                    <li><a href="{{ route('admin.jadwal.index') }}" class="p-2 hover:bg-blue-100 transition duration-200 text-black">Jadwal Guru</a></li>
                </ul>
            </li>
            <li class="mb-4 dropdown dropdown-hover">
                <div tabindex="0" role="button" class="flex items-center p-2 rounded-lg hover:bg-blue-600 hover:text-white transition duration-200 text-black">
                ...
                <ul tabindex="0" class="dropdown-content menu bg-white rounded-box z-[1] w-48 p-2 shadow-lg">
                    <li><a href="{{ route('admin.absensi.index') }}" class="p-2 hover:bg-blue-100 transition duration-200 text-black">Absensi Guru</a></li>
                    <li><a href="{{ route('admin.absensi.report') }}" class="p-2 hover:bg-blue-100 transition duration-200 text-black">Laporan Absensi Guru</a></li>
                </ul>
            </li>
            <li class="mb-4">
                <a href="{{ route('profile.edit') }}" class="flex items-center p-3 rounded-lg hover:bg-blue-600 hover:text-white transition duration-200 text-black">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="h-5 w-5 mr-2 stroke-current">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-4.41 0-8 2.69-8 6v1h16v-1c0-3.31-3.59-6-8-6z"></path>
                    </svg>
                    Profile
