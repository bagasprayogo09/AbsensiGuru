    ...
    <div class="py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            <div class="p-6 sm:p-10 bg-white shadow-lg rounded-lg transition-transform transform hover:scale-105">
                ...
                <div class="max-w-xl">
                    @include('guru.profile.partials.update-profile-information-form')
                </div>
            </div>
            ...
            <div class="p-6 sm:p-10 bg-white shadow-lg rounded-lg transition-transform transform hover:scale-105">
                ...
                <div class="max-w-xl">
                    @include('guru.profile.partials.update-password-form')
                </div>
            </div>
            <div class="p-6 sm:p-10 bg-white shadow-lg rounded-lg transition-transform transform hover:scale-105">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">{{ __('Delete Account') }}</h3>
                <div class="max-w-xl">
                    @include('guru.profile.partials.delete-user-form')
                </div>
            </div>
        </div>
    </div>
